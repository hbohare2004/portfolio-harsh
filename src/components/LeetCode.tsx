...
const difficultyStats = [
  ...
  { label: "Medium", count: 100, color: "text-yellow-400", bg: "bg-yellow-400/10", border: "border-yellow-400/20" },
  { label: "Hard", count: 6, color: "text-red-400", bg: "bg-red-400/10", border: "border-red-400/20" },
];
